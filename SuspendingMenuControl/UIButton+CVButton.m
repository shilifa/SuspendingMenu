...
@implementation UIButton (CVButton)
...
-(instancetype)initWithCVText:(NSString *)CVtext Font:(CGFloat)CVfont CVTextColor:(UIColor *)CVcolor image:(UIImage *)CVimage HLImage:(UIImage *)CVimageHL
{
    if (self = [super init]) {
        ...
        [self setTitle:CVtext forState:UIControlStateNormal];
        self.titleLabel.font = [UIFont systemFontOfSize:CVfont];
        [self setImage:CVimage forState:UIControlStateNormal];
        [self setImage:CVimageHL forState:UIControlStateSelected];
        [self setTitleColor:CVcolor forState:UIControlStateNormal];
    }
    return self;
}
...
- (void)layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyle)style
    ...
    switch (style) {
        ...
        {
            imageEdgeInsets = UIEdgeInsetsMake(-labelHeight/2, 0, labelHeight/2, -labelWidth);
